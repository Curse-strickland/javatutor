...
看板娘模型资产归原作者所有，**仅用于 Demo / 教学站点展示**。仓库内收录模型文件供部署使用，本项目不主张对其享有版权。

- 角色形象及相关视觉元素版权归 **鹰角网络（Hypergryph）** 所有；本项目为非官方个人开源教学站点，与鹰角网络无关
- Live2D 模型：原画/UI **@人形社畜**，建模 **@小布朗尼OwO**
- 详见 [`frontend/public/live2d/models/lappland/README.md`](frontend/public/live2d/models/lappland/README.md)
- 请遵守模型作者公布的使用规范（个人娱乐、禁止商用等）；本站不进行商业化盈利
